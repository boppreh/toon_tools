...
# restore_filenames
Will rename the numeric files in one folder to match the corresponding files in another folder. Assumes the alphabetical order of the files is the same in both folders.
